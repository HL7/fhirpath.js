...
Also, you could pass in a filename or a string of JSON representing a part of the resource.
If so, you should pass in the base path from which this part of the resource was extracted.
```sh
